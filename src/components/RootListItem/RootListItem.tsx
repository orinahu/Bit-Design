...
const RootListItem = ({
    ...
    return (
        <div className='bit-root-list-item'>
            <RootItemText
                name={textName}
                number={textNumber}
            ...
            <div>
                <TrafficLights className={TraficLightsClassName} textSize={TraficLightsTextSize} SDerivedStatusCounter={SDerivedStatusCounter} />
            </div>
        </div>
    )
